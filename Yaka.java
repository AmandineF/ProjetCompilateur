...
/**************************************/
  ...
  static final public void defConst() throws ParseException {
    ...
    jj_consume_token(42);
    valConst();
    tabIdent.rangeIdent(YakaTokenManager.identAStocker, new IdConst(YakaTokenManager.typeAStocker,YakaTokenManager.entierAStocker));
  }
  ...
  static final public void valConst() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
            YakaTokenManager.entierAStocker = YakaTokenManager.entierLu;
            YakaTokenManager.typeAStocker = "entier";
      break;
    case ident:
      jj_consume_token(ident);
            YakaTokenManager.entierAStocker = tabIdent.chercheIdent(YakaTokenManager.identLu).getValue();
  ...
  static final public void declVar() throws ParseException {
    jj_consume_token(VAR);
         YakaTokenManager.offset = -2;
    type();
    jj_consume_token(ident);
           YakaTokenManager.identAStocker = YakaTokenManager.identLu;
           tabIdent.rangeIdent(YakaTokenManager.identAStocker, new IdVar(YakaTokenManager.typeAStocker,YakaTokenManager.offset));
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 40:
      ...
      jj_consume_token(40);
      jj_consume_token(ident);
                YakaTokenManager.offset = YakaTokenManager.offset -2;
                YakaTokenManager.identAStocker = YakaTokenManager.identLu;
                tabIdent.rangeIdent(YakaTokenManager.identAStocker, new IdVar(YakaTokenManager.typeAStocker,YakaTokenManager.offset));
    }
    jj_consume_token(41);
 ...
 */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80000,0x200,0x0,0x120000,0x0,0x8100,0x0,0x1120000,0x0,0x400000,0x800000,0x1120000,0x120000,0x120000,0x0,0x400000,0x800000,0x1000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x100,0x50,0x100,0x0,0x200,0x80850,0x3e400,0xc0000,0x300000,0x80850,0x850,0x50,0x3e400,0xc0000,0x300000,0x80000,};
   }
